  ...
  render() {
    ...
    return (
      <li className={itemClassName}>
        <div className="kuma-timeline-item-tail" style={{ borderColor: /orange|blue|gray|green/.test(me.props.color) ? null : me.props.color }} />
        <div className={dotClassName} >
          <div className="kuma-timeline-item-head-icon" style={{ backgroundColor: /orange|blue|gray|green/.test(me.props.color) ? null : me.props.color }}>
            {me.state.dot}
          </div>
        </div>
...
TimelineItem.defaultProps = {
  ...
  last: false, // 是否最后一个
  color: 'orange', // 圆圈颜色,blue/gray/green
  // dot: false // 自定义圆圈图标
};
